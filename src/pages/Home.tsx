...
// Import content from landingContent.ts
import { features, steps, testimonials } from '@/data/landingContent';
...
export default function Home() {
  ...
  return (
    <ErrorBoundary section="Home page">
      <div className="container mx-auto px-4 py-8 max-w-7xl">
        ...
        {/* Features Section - Using content from landingContent.ts */}
        ...
        {/* How It Works - Using steps from landingContent.ts */}
        <section className="py-16 mb-20 bg-muted/30 rounded-3xl">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold mb-4">How It Works</h2>
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Getting started with NIFYA is easy and takes just minutes
            </p>
          </div>
        ...
        {/* Testimonials - Using content from landingContent.ts */}
        <section className="py-16 mb-20">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold mb-4">What Our Users Say</h2>
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Hear from professionals who rely on NIFYA every day
            </p>
          </div>
        ...
        {/* Use Cases - Kept from original design */}
        <section className="py-16 mb-20">
          <div className="text-center mb-12">
